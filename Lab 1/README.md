...
Feedback on Light Chair:
The feedback focuses on clarification of how the chair light resets. What happens if the user shifts without standing up? Is there a fixed time after which the chair lights up or does it detect when someone is sitting for too long? 
...
Light Chair:
On paper, it's easy to say that the chair lights up after sitting too long.However, when I act it out, simply standing up for a second resets the timer for the chair.How can I take care of all of these discrepancies?  Also, the light is affecting people around me. This idea is ok if you are using the chair in a private space but it is distracting for others in public.
...
Light Chair:
Instead of a light, the chair can vibrate. This would not distract people around me. Also, the chair can alter the timing based on how long someone stands up. For example, standing up for 5 seconds would not reset the timer. However, if you stand up for 1 minute or more, it will reset accordingly. 
...
This tool was very helpful. However, it is difficult to use this tool on Windows. It was easier to set up on a Mac. There can be other features added to this tool. For example, a button that allows to fade light. There can also be a feature to automate color changes. 
